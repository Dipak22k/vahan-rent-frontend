...
export default function KYCAddress({ navigation }) {
  ...
  const handleNext = () => {
    ...
    if (address.length > 10) {
        ...
        Alert.alert("Invalid Address", "Please enter your full, valid address.");
    }
  };
  // ---------------------------------------------------
  ...
  return (
    <View style={styles.container}>
      ...
      <KYCHeader title="Address Verification" />
      ...
      <ScrollView contentContainerStyle={styles.scrollInner}>
        ...
        <Animated.View style={[styles.contentArea, { opacity: fadeAnim }]}>
          <KYCProgressBar step={4} totalSteps={5} />
          
          <Text style={styles.title}>Step 4: Provide Your Residential Address</Text>
          <Text style={styles.subtitle}>
            This address will be used for official correspondence and verification.
          </Text>

          <Text style={styles.label}>Enter your full address</Text>
          <TextInput
            style={[styles.input, styles.textArea]} // Applied textArea style for height/multiline
            placeholder="123, MG Road, Mumbai"
            placeholderTextColor="#9CA3AF"
            value={address}
            onChangeText={setAddress}
            multiline
            textAlignVertical="top" // Ensures text starts at the top of the multiline input
          />
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Text style={styles.buttonText}>Submit Address & Review</Text>
          </TouchableOpacity>
        </Animated.View>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  textArea: {
      height: 100, // Explicit height for multiline input
      paddingTop: 16, // Adjust padding to look neat at the top
  },
  button: {
